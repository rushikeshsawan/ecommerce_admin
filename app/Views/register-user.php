...
<!-- Mirrored from themesbrand.com/hybrix/html/auth-signup-basic-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Feb 2023 05:33:52 GMT -->
<head>
                    ...
                    <div class="col-lg-7">
                        <div class="card mb-0 rounded-0 rounded-end border-0">
                            <div class="card-body p-4 p-sm-5 m-lg-4">
                                ...
                                <div class="p-2 mt-5">
                                    <form class="needs-validation" novalidate action="<?= base_url() ?>register-user" method="post">
