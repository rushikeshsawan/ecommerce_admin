                    ...
                    <div class="col-md-auto col-3">
                        <div class="dropdown topbar-head-dropdown topbar-tag-dropdown justify-content-end">
                            <button type="button" class="btn btn-icon btn-topbar rounded-circle text-white-50 fs-13"
                                ...
                                <img id="header-lang-img" src="<?= base_url() ?>assets/images/flags/us.svg" alt="Header Language"
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                                    ...
                                    <img src="<?= base_url() ?>assets/images/flags/us.svg" alt="user-image" class="me-2 rounded-circle"
                                        height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp"
                                    title="Spanish">
                                    <img src="<?= base_url() ?>assets/images/flags/spain.svg" alt="user-image"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr"
                                    title="German">
                                    <img src="<?= base_url() ?>assets/images/flags/germany.svg" alt="user-image"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it"
                                    title="Italian">
                                    <img src="<?= base_url() ?>assets/images/flags/italy.svg" alt="user-image"
                                        class="me-2 rounded-circle" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru"
                                    title="Russian">
                                    <img src="<?= base_url() ?>assets/images/flags/russia.svg" alt="user-image"
                                        class="me-2 rounded-circle" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ch"
                                    title="Chinese">
                                    <img src="<?= base_url() ?>assets/images/flags/china.svg" alt="user-image"
                                        class="me-2 rounded-circle" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="fr"
                                    title="French">
                                    <img src="<?= base_url() ?>assets/images/flags/french.svg" alt="user-image"
                                        class="me-2 rounded-circle" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ar"
                                    title="Arabic">
                                    <img src="<?= base_url() ?>assets/images/flags/ae.svg" alt="user-image" class="me-2 rounded-circle"
                                        height="18">
                                ...
                                <div data-simplebar style="max-height: 300px;">
                                    <div class="p-2">
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="<?= base_url() ?>assets/images/products/img-1.png"
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="<?= base_url() ?>assets/images/products/img-2.png"
                                                    class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="<?= base_url() ?>assets/images/products/img-3.png"
                                                    class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="<?= base_url() ?>assets/images/products/img-6.png"
                                                    class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="<?= base_url() ?>assets/images/products/img-5.png"
                                                    class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                        ...
                        <div data-simplebar style="max-height: 300px;" class="pe-2 ps-3 my-3">
                            <div class="list-group list-group-flush">
                                ...
                                <div class="notification-group-list">
                                    ...
                                    <a href="javascript:void(0);" class="list-group-item dropdown-item notify-item">
                                        <div class="d-flex align-items-center">
                                            <img src="<?= base_url() ?>assets/images/users/avatar-7.jpg" alt=""
                                                class="avatar-xs rounded-circle flex-shrink-0 me-2" />
                                            <div>
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="<?= base_url() ?>assets/images/logo-light.png" alt="" height="26">
                    </span>
                </a>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="bg-info-subtle rounded py-3">
                                                                <img src="<?= base_url() ?>assets/images/products/img-1.png" alt=""
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="bg-warning-subtle rounded py-3">
                                                                <img src="<?= base_url() ?>assets/images/products/img-6.png" alt=""
                                                                    style="max-height: 215px;max-width: 100%;"
                                                                    class="mx-auto d-block">
                                                            </div>
                                                            <div class="pt-3">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="bg-success-subtle rounded py-3">
                                                                <img src="<?= base_url() ?>assets/images/products/img-5.png" alt=""
                                                                    style="max-height: 215px;max-width: 100%;"
                                                                    class="mx-auto d-block">
                                                            </div>
                                                            <div class="pt-3">
                                                    ...
                                                    <div class="vstack gap-3 px-3">
                                                        <div class="p-3 border border-dashed rounded-3">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div class="flex-shrink-0">
                                                                    <span
                                                                        class="badge badge-soft-warning">Shipping</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="p-3 border border-dashed rounded-3">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div
                                                                    class="avatar-sm bg-light rounded p-1 flex-shrink-0">
                                                                    <img src="<?= base_url() ?>assets/images/products/img-4.png" alt=""
                                                                        class="img-fluid d-block">
                                                                </div>
                                                                <div class="flex-grow-1 overflow-hidden">
                                                                ...
                                                                <div class="flex-shrink-0">
                                                                    <span
                                                                        class="badge badge-soft-success">Delivered</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="p-3 border border-dashed rounded-3">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div
                                                                    class="avatar-sm bg-light rounded p-1 flex-shrink-0">
                                                                    <img src="<?= base_url() ?>assets/images/products/img-3.png" alt=""
                                                                        class="img-fluid d-block">
                                                                </div>
                                                                <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <div class="p-3 border border-dashed rounded-3">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div
                                                                    class="avatar-sm bg-light rounded p-1 flex-shrink-0">
                                                                    <img src="<?= base_url() ?>assets/images/products/img-9.png" alt=""
                                                                        class="img-fluid d-block">
                                                                </div>
                                                                <div class="flex-grow-1 overflow-hidden">
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="badge badge-soft-success">In
                                                                        Stock</span>
                                                                </td>
                                                                <td>15 PCS</td>
                                                            </tr><!-- end tr -->
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="badge badge-soft-warning">Low
                                                                        Stock</span>
                                                                </td>
                                                                <td>05 PCS</td>
                                                            </tr><!-- end tr -->
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="<?= base_url() ?>assets/images/products/img-4.png"
                                                                                alt=""
                                                                                class="avatar-xs rounded-circle" />
                                                                        </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="<?= base_url() ?>assets/images/products/img-8.png"
                                                                                alt=""
                                                                                class="avatar-xs rounded-circle" />
                                                                        </div>
